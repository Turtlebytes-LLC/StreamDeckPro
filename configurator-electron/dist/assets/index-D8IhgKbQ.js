(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&n(c)}).observe(document,{childList:!0,subtree:!0});function s(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(a){if(a.ep)return;a.ep=!0;const o=s(a);fetch(a.href,o)}})();let i={},T=null,B=[],E=!1,u=null;async function Z(){const t=i.streamdeck+"/.device-info.json",e=await window.api.readFile(t);if(e.success)try{u=JSON.parse(e.content),X()}catch{u=null}}function M(){var t;return((t=u==null?void 0:u.profile)==null?void 0:t.buttons)||8}function H(){var t;return((t=u==null?void 0:u.profile)==null?void 0:t.dials)||4}function A(){var t,e;return((e=(t=u==null?void 0:u.profile)==null?void 0:t.touchscreen)==null?void 0:e.zones)||4}function j(){return H()>0}function K(){var t;return((t=u==null?void 0:u.profile)==null?void 0:t.touchscreen)!=null}function X(){const t=(u==null?void 0:u.device_type)||"Stream Deck Plus";document.getElementById("status-text").textContent=`Connected: ${t}`;const e=document.querySelector('[data-tab="dials"]'),s=document.querySelector('[data-tab="touchscreen"]');e&&(e.style.display=j()?"":"none"),s&&(s.style.display=K()?"":"none")}document.addEventListener("DOMContentLoaded",async()=>{i=await window.api.getDirectories(),await Z(),J(),G(),Q(),V(),ot(),await b(),j()&&await k(),K()&&await m();const t=(u==null?void 0:u.device_type)||"Stream Deck";r(`Ready to configure your ${t}`,"success")});function J(){E=localStorage.getItem("darkMode")==="true",R(),document.getElementById("theme-toggle").addEventListener("click",()=>{E=!E,localStorage.setItem("darkMode",E),R()})}function R(){const t=document.getElementById("theme-icon");E?(document.documentElement.classList.add("dark"),document.body.classList.add("dark"),t.textContent="☀️"):(document.documentElement.classList.remove("dark"),document.body.classList.remove("dark"),t.textContent="🌙")}function G(){document.querySelectorAll(".tab").forEach(t=>{t.addEventListener("click",()=>$(t.dataset.tab))})}function $(t){document.querySelectorAll(".tab").forEach(e=>{e.dataset.tab===t?(e.classList.remove("tab-inactive"),e.classList.add("tab-active")):(e.classList.remove("tab-active"),e.classList.add("tab-inactive"))}),document.querySelectorAll(".tab-content").forEach(e=>{e.classList.add("hidden")}),document.getElementById(t+"-tab").classList.remove("hidden")}function Q(){document.addEventListener("keydown",t=>{(t.ctrlKey&&t.key==="w"||t.ctrlKey&&t.key==="q"||t.key==="Escape")&&(t.preventDefault(),window.close()),t.ctrlKey&&t.key==="1"&&$("buttons"),t.ctrlKey&&t.key==="2"&&$("dials"),t.ctrlKey&&t.key==="3"&&$("touchscreen"),t.ctrlKey&&t.key==="e"&&(t.preventDefault(),q()),t.ctrlKey&&t.key==="i"&&(t.preventDefault(),O()),t.ctrlKey&&t.key==="d"&&(t.preventDefault(),document.getElementById("theme-toggle").click())})}function V(){document.getElementById("export-btn").addEventListener("click",q),document.getElementById("import-btn").addEventListener("click",O),document.getElementById("autostart-btn").addEventListener("click",Y),z()}async function z(){const t=await window.api.checkAutostart(),e=document.getElementById("autostart-btn");t.success&&t.enabled?(e.innerHTML="<span>✓</span> Auto-start ON",e.classList.add("bg-green-500/20")):(e.innerHTML="<span>⚙️</span> Auto-start",e.classList.remove("bg-green-500/20"))}async function Y(){const t=await window.api.checkAutostart(),e=!(t.success&&t.enabled);await window.api.toggleAutostart(e),await z(),r(e?"Auto-start enabled":"Auto-start disabled","success")}async function q(){const t=await window.api.browseSaveFile({title:"Export Configuration",defaultPath:"streamdeck-config.tar.gz",filters:[{name:"Tar Archive",extensions:["tar.gz"]}]});if(!t.canceled&&t.filePath){const e=`tar -czf "${t.filePath}" -C "${i.streamdeck}" buttons dials touchscreen`,s=await window.api.execCommand(e);s.success?r("Configuration exported successfully","success"):r("Export failed: "+s.error,"error")}}async function O(){const t=await window.api.browseFile({title:"Import Configuration",filters:[{name:"Tar Archive",extensions:["tar.gz"]}]});if(!t.canceled&&t.filePaths.length>0){const e=`tar -xzf "${t.filePaths[0]}" -C "${i.streamdeck}"`,s=await window.api.execCommand(e);s.success?(r("Configuration imported - reloading...","success"),await Promise.all([b(),k(),m()]),await window.api.restartDaemon()):r("Import failed: "+s.error,"error")}}function r(t,e="info"){const s=document.getElementById("toast-container"),n=document.createElement("div"),a={success:"✓",error:"✕",warning:"⚠",info:"ℹ"},o={success:"bg-deck-success",error:"bg-deck-danger",warning:"bg-deck-warning",info:"bg-deck-primary"};n.className=`toast ${o[e]}`,n.innerHTML=`
...
`);for(const a of s)if(a.startsWith("# Description:"))return a.replace("# Description:","").trim();const n=s.find(a=>a.trim()&&!a.startsWith("#"));return n?n.substring(0,40)+(n.length>40?"...":""):"Script configured"}async function b(){const t=document.getElementById("buttons-container"),e=t.scrollTop;t.innerHTML="";const s=M();for(let n=1;n<=s;n++){const a=await tt(n);t.appendChild(a)}t.scrollTop=e,document.getElementById("apply-button-fontsize").onclick=async()=>{const n=document.getElementById("button-fontsize-all").value,a=M();for(let o=1;o<=a;o++)await h(i.buttons+"/button-"+o+"-fontsize.txt",n);r(`Font size ${n} applied to all buttons`,"success"),await b()}}async function tt(t){const e=document.createElement("div");e.className="card animate-fade-in";const s=i.buttons+"/button-"+t+".sh",n=await U(i.buttons,"button-"+t),a=i.buttons+"/button-"+t+".txt",o=i.buttons+"/button-"+t+"-position.txt",c=i.buttons+"/button-"+t+"-fontsize.txt",d=await y(s),f=await x(a),p=await x(o)||"bottom",g=await x(c)||"24";let l=`
  ...
  `,l+="</div>",e.innerHTML=l,e}async function k(){const t=document.getElementById("dials-container"),e=t.scrollTop;t.innerHTML="";const s=H();for(let n=1;n<=s;n++){const a=await et(n);t.appendChild(a)}t.scrollTop=e}async function et(t){const e=document.createElement("div");e.className="card animate-fade-in";const s=[{key:"cw",name:"Clockwise",icon:"↻",color:"text-blue-500"},{key:"ccw",name:"Counter-Clockwise",icon:"↺",color:"text-green-500"},{key:"press",name:"Press",icon:"⬇",color:"text-amber-500"},{key:"longpress",name:"Long Press",icon:"⏱",color:"text-red-500"}];let n=0;for(const o of s){const c=i.dials+"/dial-"+t+"-"+o.key+".sh";await y(c)&&n++}let a=`
  ...
  `;for(const o of s){const c=i.dials+"/dial-"+t+"-"+o.key+".sh",d=await y(c);a+=`
    ...
    `}return a+="</div>",e.innerHTML=a,e}async function m(){const t=document.getElementById("touchscreen-container"),e=t.scrollTop;t.innerHTML="";const s=A();for(let a=1;a<=s;a++){const o=await st(a);t.appendChild(o)}const n=await nt();t.appendChild(n),t.scrollTop=e,document.getElementById("apply-touch-fontsize").onclick=async()=>{const a=document.getElementById("touch-fontsize-all").value,o=A();for(let c=1;c<=o;c++)await h(i.touch+"/touch-"+c+"-fontsize.txt",a);r(`Font size ${a} applied to all zones`,"success"),await m()}}async function st(t){const e=document.createElement("div");e.className="card animate-fade-in";const s=await U(i.touch,"touch-"+t),n=i.touch+"/touch-"+t+".txt",a=i.touch+"/touch-"+t+"-position.txt",o=i.touch+"/touch-"+t+"-fontsize.txt",c=await x(n),d=await x(a)||"middle",f=await x(o)||"28",p=[{suffix:"",name:"Tap",icon:"👆"},{suffix:"-longpress",name:"Long Press",icon:"⏱"},{suffix:"-swipe-up",name:"Swipe Up",icon:"⬆️"},{suffix:"-swipe-down",name:"Swipe Down",icon:"⬇️"},{suffix:"-swipe-left",name:"Swipe Left",icon:"⬅️"},{suffix:"-swipe-right",name:"Swipe Right",icon:"➡️"}];let g=0;for(const w of p){const S=i.touch+"/touch-"+t+w.suffix+".sh";await y(S)&&g++}let l=`
    <div class="card-header card-header-purple">
      <span class="w-8 h-8 bg-white/20 rounded-lg flex items-center justify-center font-bold">${t}</span>
      <span>Touch Zone ${t}</span>
      <span class="badge ${g>0?"badge-success":"badge-warning"} ml-auto">${g}/6</span>
    </div>
    <div class="space-y-4">
  ...
  `,l+='<div class="divider"></div>',l+='<div class="space-y-1">';for(const w of p){const S=i.touch+"/touch-"+t+w.suffix+".sh",I=await y(S);l+=`
      <div class="action-row">
        <div class="action-label">
          <span class="text-lg">${w.icon}</span>
          ${w.name}
        </div>
        <div class="action-status ${I?"action-status-configured":""}">
          ${I?await L(S):"Not configured"}
        </div>
        <div class="flex gap-1">
    ...
    `}return l+="</div></div>",e.innerHTML=l,e}async function nt(){const t=document.createElement("div");t.className="card animate-fade-in";let e=`
  ...
  `;for(const s of["left","right"]){const n=i.touch+"/longswipe-"+s+".sh",a=await y(n),o=s==="left"?"⬅️":"➡️",c=s.charAt(0).toUpperCase()+s.slice(1);e+=`
    ...
    `}return e+="</div>",t.innerHTML=e,t}window.browseScript=async t=>{const e=await window.api.browseFile({title:"Select Script File",defaultPath:i.examples,filters:[{name:"Shell Scripts",extensions:["sh"]}]});if(!e.canceled&&e.filePaths.length>0){const s=i.buttons+"/button-"+t+".sh";await window.api.copyFile(e.filePaths[0],s),await window.api.makeExecutable(s),r("Script assigned to Button "+t,"success"),await b()}};window.removeScript=async t=>{const e=i.buttons+"/button-"+t+".sh";await v(e),r("Script removed from Button "+t,"success"),await b()};window.browseImage=async(t,e)=>{const s=await window.api.browseFile({title:"Select Image File",filters:[{name:"Images",extensions:["png","jpg","jpeg","svg"]}]});if(!s.canceled&&s.filePaths.length>0){const n=e==="button"?i.buttons:i.touch,a=e==="button"?"button-"+t:"touch-"+t,o=s.filePaths[0].split(".").pop(),c=n+"/"+a+"."+o;await window.api.copyFile(s.filePaths[0],c),r("Image set","success"),e==="button"?await b():await m()}};window.removeImage=async(t,e)=>{const s=e==="button"?i.buttons:i.touch,n=e==="button"?"button-"+t:"touch-"+t;for(const a of[".png",".jpg",".jpeg",".svg"]){const o=s+"/"+n+a;await y(o)&&await v(o)}r("Image removed","success"),e==="button"?await b():await m()};window.setLabel=async(t,e)=>{const s=e==="button"?"button":"touch",n=e==="button"?i.buttons:i.touch,a=document.getElementById(s+"-"+t+"-label").value,o=n+"/"+s+"-"+t+".txt",c=n+"/"+s+"-"+t+"-position.txt",d=n+"/"+s+"-"+t+"-fontsize.txt";a.trim()?await h(o,a.trim()):await v(o);const f=document.getElementById(s+"-"+t+"-position").value;await h(c,f);const p=document.getElementById(s+"-"+t+"-fontsize").value;await h(d,p),r("Settings saved","success")};window.selectIcon=(t,e)=>{T={num:t,type:e},it()};window.editScript=async t=>{await window.api.execCommand('xdg-open "'+t+'"'),r("Opening script in editor","info")};window.browseDialScript=async(t,e)=>{const s=await window.api.browseFile({title:"Select Script File",defaultPath:i.examples,filters:[{name:"Shell Scripts",extensions:["sh"]}]});if(!s.canceled&&s.filePaths.length>0){const n=i.dials+"/dial-"+t+"-"+e+".sh";await window.api.copyFile(s.filePaths[0],n),await window.api.makeExecutable(n),r("Script assigned","success"),await k()}};window.removeDialScript=async(t,e)=>{const s=i.dials+"/dial-"+t+"-"+e+".sh";await v(s),r("Script removed","success"),await k()};window.browseTouchScript=async(t,e)=>{const s=await window.api.browseFile({title:"Select Script File",defaultPath:i.examples,filters:[{name:"Shell Scripts",extensions:["sh"]}]});if(!s.canceled&&s.filePaths.length>0){const n=i.touch+"/touch-"+t+e+".sh";await window.api.copyFile(s.filePaths[0],n),await window.api.makeExecutable(n),r("Script assigned","success"),await m()}};window.removeTouchScript=async(t,e)=>{const s=i.touch+"/touch-"+t+e+".sh";await v(s),r("Script removed","success"),await m()};window.browseLongSwipeScript=async t=>{const e=await window.api.browseFile({title:"Select Script File",defaultPath:i.examples,filters:[{name:"Shell Scripts",extensions:["sh"]}]});if(!e.canceled&&e.filePaths.length>0){const s=i.touch+"/longswipe-"+t+".sh";await window.api.copyFile(e.filePaths[0],s),await window.api.makeExecutable(s),r("Script assigned","success"),await m()}};window.removeLongSwipeScript=async t=>{const e=i.touch+"/longswipe-"+t+".sh";await v(e),r("Script removed","success"),await m()};window.browseExamples=async(t,e)=>{const s=await window.api.browseFile({title:"Select Example Script",defaultPath:i.examples,filters:[{name:"Shell Scripts",extensions:["sh"]}]});if(!s.canceled&&s.filePaths.length>0){const n=i.buttons+"/button-"+t+".sh";await window.api.copyFile(s.filePaths[0],n),await window.api.makeExecutable(n),r("Example script assigned","success"),await b()}};window.browseDialExamples=async(t,e)=>{const s=await window.api.browseFile({title:"Select Example Script",defaultPath:i.examples,filters:[{name:"Shell Scripts",extensions:["sh"]}]});if(!s.canceled&&s.filePaths.length>0){const n=i.dials+"/dial-"+t+"-"+e+".sh";await window.api.copyFile(s.filePaths[0],n),await window.api.makeExecutable(n),r("Example script assigned","success"),await k()}};window.browseTouchExamples=async(t,e)=>{const s=await window.api.browseFile({title:"Select Example Script",defaultPath:i.examples,filters:[{name:"Shell Scripts",extensions:["sh"]}]});if(!s.canceled&&s.filePaths.length>0){const n=i.touch+"/touch-"+t+e+".sh";await window.api.copyFile(s.filePaths[0],n),await window.api.makeExecutable(n),r("Example script assigned","success"),await m()}};window.browseLongSwipeExamples=async t=>{const e=await window.api.browseFile({title:"Select Example Script",defaultPath:i.examples,filters:[{name:"Shell Scripts",extensions:["sh"]}]});if(!e.canceled&&e.filePaths.length>0){const s=i.touch+"/longswipe-"+t+".sh";await window.api.copyFile(e.filePaths[0],s),await window.api.makeExecutable(s),r("Example script assigned","success"),await m()}};window.recordAction=async(t,e)=>{const s=P("Button "+t);document.body.appendChild(s);const n=await C(s);if(n.length>0){const a=F(n),o=i.buttons+"/button-"+t+".sh";await h(o,a),await window.api.makeExecutable(o),r("Recorded "+n.length+" actions","success"),await b()}document.body.removeChild(s)};window.recordDialAction=async(t,e)=>{const s={cw:"Clockwise",ccw:"Counter-Clockwise",press:"Press",longpress:"Long Press"},n=P("Dial "+t+" - "+s[e]);document.body.appendChild(n);const a=await C(n);if(a.length>0){const o=F(a),c=i.dials+"/dial-"+t+"-"+e+".sh";await h(c,o),await window.api.makeExecutable(c),r("Recorded "+a.length+" actions","success"),await k()}document.body.removeChild(n)};window.recordTouchAction=async(t,e)=>{const s={"":"Tap","-longpress":"Long Press","-swipe-up":"Swipe Up","-swipe-down":"Swipe Down","-swipe-left":"Swipe Left","-swipe-right":"Swipe Right"},n=P("Touch Zone "+t+" - "+s[e]);document.body.appendChild(n);const a=await C(n);if(a.length>0){const o=F(a),c=i.touch+"/touch-"+t+e+".sh";await h(c,o),await window.api.makeExecutable(c),r("Recorded "+a.length+" actions","success"),await m()}document.body.removeChild(n)};window.recordLongSwipeAction=async t=>{const e=P("Long Swipe "+t.charAt(0).toUpperCase()+t.slice(1));document.body.appendChild(e);const s=await C(e);if(s.length>0){const n=F(s),a=i.touch+"/longswipe-"+t+".sh";await h(a,n),await window.api.makeExecutable(a),r("Recorded "+s.length+" actions","success"),await m()}document.body.removeChild(e)};function P(t){const e=document.createElement("div");return e.className="modal-backdrop",e.innerHTML=`
  ...
  `,e}function C(t){return new Promise(e=>{const s=[],n=t.querySelector("#recorded-events"),a=c=>{c.preventDefault(),c.stopPropagation();const d=c.key,f=c.code,p=[];c.ctrlKey&&p.push("ctrl"),c.shiftKey&&p.push("shift"),c.altKey&&p.push("alt"),c.metaKey&&p.push("super");const g={type:"key",key:d,code:f,modifiers:p};s.push(g);const l=p.length>0?p.join("+")+"+":"",w=d===" "?"Space":d;n.innerHTML+=`<div class="text-blue-600 dark:text-blue-400">Key: ${l}${w}</div>`,n.scrollTop=n.scrollHeight},o=c=>{if(c.target.closest("#record-cancel")||c.target.closest("#record-save"))return;c.preventDefault();const d=c.button===0?"left":c.button===1?"middle":"right";s.push({type:"mouse",button:d}),n.innerHTML+=`<div class="text-green-600 dark:text-green-400">Mouse: ${d} click</div>`,n.scrollTop=n.scrollHeight};document.addEventListener("keydown",a),document.addEventListener("mousedown",o),t.querySelector("#record-save").onclick=()=>{document.removeEventListener("keydown",a),document.removeEventListener("mousedown",o),e(s)},t.querySelector("#record-cancel").onclick=()=>{document.removeEventListener("keydown",a),document.removeEventListener("mousedown",o),e([])}})}function at(t,e){const s={" ":"space",Enter:"Return",Escape:"Escape",Tab:"Tab",Backspace:"BackSpace",Delete:"Delete",Insert:"Insert",Home:"Home",End:"End",PageUp:"Page_Up",PageDown:"Page_Down",ArrowUp:"Up",ArrowDown:"Down",ArrowLeft:"Left",ArrowRight:"Right",PrintScreen:"Print",ScrollLock:"Scroll_Lock",Pause:"Pause",CapsLock:"Caps_Lock",NumLock:"Num_Lock",ContextMenu:"Menu",F1:"F1",F2:"F2",F3:"F3",F4:"F4",F5:"F5",F6:"F6",F7:"F7",F8:"F8",F9:"F9",F10:"F10",F11:"F11",F12:"F12"};return s[t]?s[t]:t.length===1?t.toLowerCase():t}function F(t){let e=`#!/bin/bash

`;for(const s of t)if(s.type==="key"){const n=at(s.key,s.code),a=s.modifiers.join("+"),o=a?a+"+"+n:n;e+=`xdotool key "${o}"
`}else if(s.type==="mouse"){const n=s.button==="left"?1:s.button==="middle"?2:3;e+=`xdotool click ${n}
`}return e}function ot(){document.getElementById("close-icon-modal").addEventListener("click",_),document.getElementById("icon-category").addEventListener("change",D),document.getElementById("icon-color").addEventListener("change",D),document.getElementById("icon-search").addEventListener("input",W)}async function it(){const t=document.getElementById("icon-modal");t.classList.remove("hidden"),t.classList.add("flex"),await D()}function _(){const t=document.getElementById("icon-modal");t.classList.add("hidden"),t.classList.remove("flex")}async function D(){const t=document.getElementById("icon-category").value,e=document.getElementById("icon-color").value,s=i.icons+"/"+t+"/"+e,n=await window.api.listDirectory(s);if(n.success)B=n.files.filter(a=>a.endsWith(".png")),W();else{B=[];const a=document.getElementById("icon-grid");a.innerHTML=`
    ...
    `}}function W(){const t=document.getElementById("icon-search").value.toLowerCase(),e=B.filter(a=>a.toLowerCase().includes(t)),s=document.getElementById("icon-grid");s.innerHTML="";const n=Math.min(e.length,48);for(let a=0;a<n;a++){const o=e[a],c=document.getElementById("icon-category").value,d=document.getElementById("icon-color").value,f=i.icons+"/"+c+"/"+d+"/"+o,p=document.createElement("div");p.className="icon-item group relative",p.title=o.replace(".png",""),p.onclick=()=>ct(f),window.api.readImageBase64(f).then(g=>{if(g.success){const l=document.createElement("img");l.src=g.data,l.className="w-10 h-10",p.appendChild(l)}}),s.appendChild(p)}if(n===0)s.innerHTML=`
      <div class="col-span-6 empty-state">
        <div class="empty-state-icon">🔍</div>
        <div>No matching icons</div>
      </div>
    `;else if(e.length>48){const a=document.createElement("div");a.className="col-span-6 text-center text-sm text-gray-500 dark:text-gray-400 py-4",a.textContent=`Showing first 48 of ${e.length} icons. Refine your search to see more.`,s.appendChild(a)}}async function ct(t){if(!T)return;const{num:e,type:s}=T,n=s==="button"?i.buttons:i.touch,a=s==="button"?"button-"+e:"touch-"+e,o=n+"/"+a+".png";await window.api.copyFile(t,o),r("Icon applied","success"),_(),s==="button"?await b():await m()}
